         ...
         <div className="row">
               ...
               <div className="card">
                  <div className="card-body">
                     <div className="media distance-bx align-items-center">
                        <span className="icon bg-warning shadow-warning me-3">
                           <svg
                              width={24}
                              height={24}
                              viewBox="0 0 24 24"
            ...
            <div className="col-xl-6">
               <div className="card">
                  <div className="card-body">
                     <div className="media distance-bx align-items-center">
                        <span className="icon bg-info shadow-info me-3">
                           <svg
                              width={24}
                              height={24}
                              viewBox="0 0 24 24"
            ...
            <div className="col-xl-3 col-xxl-4 col-lg-4">
               <div className="card">
                  ...
                  <div className="card-body dz-scroll height370">
                     <div className="d-flex py-3 border-bottom align-items-center">
                        <span className="activity-icon border border-warning border-2 me-3">
                           <svg
                              width={24}
                              height={24}
                              viewBox="0 0 24 24"
                     ...
                     <div className="d-flex py-3 border-bottom align-items-center">
                        <span className="activity-icon border border-info border-2 me-3">
                           <svg
                              width={24}
                              height={24}
                              viewBox="0 0 24 24"
