                  ...
                  <div className="col-xl-12">
                     <div className="card plan-list">
                        <div className="card-header d-sm-flex d-block pb-0 border-0">
                           ...
                           <Link
                              to="/workout-plan"
                              className="btn rounded text-black border border-light me-4"
                           >
                              <svg
                                 className="me-2"
                                 width={25}
                        ...
                        <div className="card-body">
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              <div className="list-icon me-3 mb-3">
                              ...
                              <div className="d-flex mb-3 me-auto pl-3 pr-3 align-items-center">
                                 <svg
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24"
                              ...
                              <Link
                                 to="/workout-plan"
                                 className="btn mb-3 btn-outline-primary rounded me-3"
                              >
                           ...
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <div className="d-flex me-auto mb-3 pl-3 pr-3 align-items-center">
                                 <svg
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24"
                              ...
                              <Link
                                 to="/workout-plan"
                                 className="btn btn-outline-primary rounded me-3 mb-3"
                              >
                                 <i className="las la-caret-right scale-2 me-3" />
                                 Start Workout
                              </Link>
                           ...
                           <div className="d-flex px-3 pt-3 list-row flex-wrap align-items-center mb-2">
                              ...
                              <div className="d-flex me-auto pl-3 mb-3 pr-3 align-items-center">
                                 <svg
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24"
                              ...
                              <Link
                                 to="/workout-plan"
                                 className="mb-3 btn btn-primary rounded me-3"
                              >
                                 <i className="las la-stop scale-2 me-3" />
                                 Set Finish
                              </Link>
                              <Dropdown className="dropdown mb-3">
                                 <Dropdown.Toggle
